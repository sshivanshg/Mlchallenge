#!/usr/bin/env python3
"""
ML Challenge 2026 — Submission Validator (SUPPLEMENTARY streaming variant)

NOT the official validator. This is a modified copy of
student_resource/utils/validate_submission.py that checks candidate_pairs.tsv
without holding the full candidate mapping in memory. The official file is kept
unmodified; always also run it on matching_results.tsv.
